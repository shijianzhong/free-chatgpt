...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__8A64216",
    appName: "video-without-watermark",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
let S;
S = _;
const k = m('{\n    "address": [\n        "127.0.0.1",\n        "192.168.2.144"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "local",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**",\n        "/Applications/HBuilderX.app/Contents/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), I = m('[{"provider":"aliyun","spaceName":"pic","spaceId":"mp-e067308a-7a2a-45e5-9e12-56cd9bfa87ce","clientSecret":"7lkdfpvSc0bNWo7Vub0c0g==","endpoint":"https://api.next.bspapp.com"}]') || [];
let T = "";
try {
  T = "__UNI__8A64216";
} catch (e2) {
